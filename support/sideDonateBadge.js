...
axoSideDonateContent.style.cssText = `background:${axoSideDonateBG};border:1.5px solid ${axoSideDonateBORDER};border-left:none;border-right:none;padding:.4rem.5rem;color:${axoSideDonateColor};text-decoration:none;transform:translate(100%);white-space:nowrap;`;
axoSideDonate.style.cssText = "font-family: 'Roboto', sans-serif;z-index:99999999;display: flex;position: fixed;right: 0;bottom: 3rem;height: 3.5rem;width: 3.5rem;cursor: pointer;"
